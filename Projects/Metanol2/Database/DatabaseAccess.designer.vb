...
Namespace Data
	...
	<System.Data.Linq.Mapping.DatabaseAttribute(Name:="Metanol")>  _
    ...
    #End Region
		...
		<Column(Storage:="_PictureID", DbType:="Int NOT NULL", IsPrimaryKey:=true)>  _
		...
		<Column(Storage:="_Model", DbType:="NVarChar(1024)")>  _
		...
		<Column(Storage:="_Digitized", DbType:="DateTime")>  _
		...
		<Association(Name:="Picture_Exif", Storage:="_Picture", ThisKey:="PictureID", OtherKey:="ID", IsForeignKey:=true, DeleteOnNull:=true, DeleteRule:="CASCADE")>  _
    ...
    #End Region
		...
		<Column(Storage:="_ObjectName", DbType:="VarChar(1024)")>  _
		...
		<Column(Storage:="_Text", DbType:="VarChar(MAX)")>  _
		...
		<Column(Storage:="_City", DbType:="VarChar(1024)")>  _
		...
		<Column(Storage:="_Country", DbType:="VarChar(1024)")>  _
		...
		<Column(Storage:="_Province", DbType:="VarChar(1024)")>  _
		...
		<Column(Storage:="_Sublocation", DbType:="VarChar(1024)")>  _
		...
		<Column(Storage:="_Keywords", DbType:="VarChar(MAX)")>  _
		...
		<Column(Storage:="_Copyright", DbType:="VarChar(1024)")>  _
		...
		<Column(Storage:="_Credit", DbType:="VarChar(1024)")>  _
		...
		<Column(Storage:="_EditStatus", DbType:="VarChar(1024)")>  _
		...
		<Column(Storage:="_Urgence", DbType:="Decimal(1,0)")>  _
		...
		<Association(Name:="Picture_IPTC", Storage:="_Picture", ThisKey:="PictureID", OtherKey:="ID", IsForeignKey:=true, DeleteOnNull:=true, DeleteRule:="CASCADE")>  _
		Public Property Picture() As Picture
			Get
				Return Me._Picture.Entity
			End Get
    ...
    #End Region
		...
		<Column(Storage:="_FileName", DbType:="VarChar(256) NOT NULL", CanBeNull:=false)>  _
		...
		<Column(Storage:="_Folder", DbType:="VarChar(512) NOT NULL", CanBeNull:=false)>  _
		...
		<Column(Storage:="_x", DbType:="Int NOT NULL")>  _
		...
		<Column(Storage:="_y", DbType:="Int NOT NULL")>  _
		...
		<Column(Storage:="_LastSync", DbType:="DateTime NOT NULL")>  _
		...
		<Association(Name:="Picture_Exif", Storage:="_Exif", ThisKey:="ID", OtherKey:="PictureID", IsUnique:=true, IsForeignKey:=false)>  _
		...
		<Association(Name:="Picture_IPTC", Storage:="_IPTC", ThisKey:="ID", OtherKey:="PictureID", IsUnique:=true, IsForeignKey:=false)>  _
	...
	<Table(Name:="dbo.PictureMetadata")>  _
