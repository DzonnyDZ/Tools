...
#If VBC_VER >= 9 Then
        <Author("Đonny", "dzony.dz@gmail.com"), Version(1, 0, GetType(Interaction), LastChange:="10/30/2007")> _
...
#If Config <= Alpha Then 'Stage:Alpha
        ...
        <Version(1, 0, GetType(Interaction), LastChange:="05/21/2007")> _
...
#If Config <= Nightly Then 'Stage: Nightly
        ...
        <Author("Đonny", "dzonny@dzonny.cz", "http://dzonny.cz")> _
        <Version(1, 0, GetType(Interaction), LastChange:="10/02/2007")> _
