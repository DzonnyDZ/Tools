...
#Region "Property"
        ...
        <KnownCategory(KnownCategoryAttribute.KnownCategories.Behavior), LDescription(GetType(WindowsT.FormsT.DerivedControls), "AutoText_d")> _
        <DefaultValue(True)> _
        ...
        <KnownCategory(KnownCategoryAttribute.KnownCategories.Appearance), LDescription(GetType(WindowsT.FormsT.DerivedControls), "AutoTextFormat_d")> _
        <Localizable(True)> _
...
#Region "Events"
        ...
        <KnownCategory(KnownCategoryAttribute.AnotherCategories.PropertyChanged), LDescription(GetType(WindowsT.FormsT.DerivedControls), "ValueChanged_d")> _
        Public Event ValueChanged As EventHandler
        ''' <summary>Ocuurs when <see cref="AutoText"/> changes</summary>
        <KnownCategory(KnownCategoryAttribute.AnotherCategories.PropertyChanged), LDescription(GetType(WindowsT.FormsT.DerivedControls), "AutoTextChanged_d")> _
        Public Event AutoTextChanged As EventHandler
        ''' <summary>Ocuurs when <see cref="AutoTextFormat"/> changes</summary>
        <KnownCategory(KnownCategoryAttribute.AnotherCategories.PropertyChanged), LDescription(GetType(WindowsT.FormsT.DerivedControls), "AutoTextFormatChanged_d")> _
