...
<Author("Đonny", "dzony.dz@gmail.com"), Version(1, 0, GetType(ICloneable(Of Char)), LastChMMDDYYYY:="12/20/2006")> _
...
''' </remarks>
<Author("Đonny", "dzony.dz@gmail.com"), Version(1, 0, GetType(Cloenable(Of Char)))> _
