...
#If Config <= Release Then
    ...
    <Author("Đonny", "dzonny.dz@gmail.com"), Version(1, 0, GetType(IPair(Of String, Char)), LastChMMDDYYYY:="12/21/2006")> _
...
#If Config <= Release Then
    ...
    <Author("Đonny", "dzonny.dz@gmail.com"), Version(1, 0, GetType(Pair(Of String, Char)), LastChMMDDYYYY:="12/21/2006")> _
    ...
    <Author("Đonny", "dzonny.dz@gmail.com"), Version(1, 0, GetType(Pair(Of Long)), LastChMMDDYYYY:="12/21/2006")> _
