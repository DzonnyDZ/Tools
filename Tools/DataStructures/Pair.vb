...
#If Config <= Beta Then
    ...
    <Author("Ðonny", "dzonny.dz@gmail.com"), Version(1, 0, GetType(Pair(Of String, Char)), LastChange:="12/21/2006")> _
    ...
    <Author("Ðonny", "dzonny.dz@gmail.com"), Version(1, 0, GetType(Pair(Of Long)), LastChange:="12/21/2006")> _
