...
Namespace DrawingT.DesignT
    ...
    Public MustInherit Class UITypeEditor(Of T)
        ...
        <EditorBrowsable(EditorBrowsableState.Never), Obsolete("Use type safe-overload instead")>
        Public NotOverridable Overrides Function EditValue(ByVal context As ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
        ...
        Public Class PaintValueEventArgs
            ...
            Private Shared Function VerifyValue(ByVal value As Object) As T
                If Not TypeOf value Is T Then Throw New TypeMismatchException(String.Format(OnlyValueSOfType0CanBeEditedBy0, GetType(T).Name, GetType(UITypeEditor(Of T)).Name), value, GetType(T))
                Return value
            End Function
    ...
    Public Class DropDownControlEditor(Of T, TControl As {IEditor(Of T), New, Control})
        ...
        ''' </remarks>
        Protected Overridable Function ShowDropDown(ByVal control As TControl, ByVal provider As IServiceProvider, ByVal context As ITypeDescriptorContext) As Boolean
        ...
        ''' <para>Note for inheritors: Inheritor should ensure that each instance of <typeparamref name="TControl"/> is being shown only once at same time.</para>
        ''' </remarks>
        ''' <version version="1.5.4">Parameter <c>Control</c> renamed to <c>control</c></version>
        ...
        Public Overloads Overrides Function EditValue(ByVal context As ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As T) As T
        ...
        Public NotOverridable Overrides Function GetEditStyle(ByVal context As ITypeDescriptorContext) As UITypeEditorEditStyle
    ...
    ''' <remarks>This type is usually implemented by class derived from <see cref="Control"/> (such as <see cref="DropDownUITypeEditorControlBase(Of T)"/>).
    ...
    Public Interface IEditor(Of T)
        ...
        ''' <summary>Owner of control informs control that it is about to be shown by calling this method. It is called just before the control is shown.</summary>
        Sub OnBeforeShow()
        ''' <summary>Informs control that it was just hidden by calling this method.</summary>
        ''' <remarks>When implementing editor for reference type that is edited by changing its properties instead of changing its instance. Properties should be changed in this method and only if <see cref="Result"/> is true.</remarks>
        Sub OnClosed()
    End Interface
    ...
    Public MustInherit Class DropDownUITypeEditorControlBase(Of T)
        ...
        ''' <summary>When overridden in derived class updates the <see cref="Value"/> property with value generated by actual state of control</summary>
        ''' <remarks>
        ...
        Protected Overridable Property Context As ITypeDescriptorContext Implements IEditor(Of T).Context
        ...
        End Sub
        ''' <summary>Informs control that it was just hidden by calling this method.</summary>
        ''' <remarks>When implementing editor for reference type that is edited by changing its properties instead of changing its instance. Properties should be changed in this method and only if <see cref="Result"/> is true.<para>This implementation does nothing.</para></remarks>
        ...
        ''' <remarks>This property is set by owner of the control and is valid between calls of <see cref="OnBeforeShow"/> and <see cref="OnClosed"/>.</remarks>
        <EditorBrowsable(EditorBrowsableState.Never)>
        Protected Overridable Property Service As IWindowsFormsEditorService Implements IEditor(Of T).Service
