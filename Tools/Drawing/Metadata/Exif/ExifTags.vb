			...
			<CLSCompliant(False)> Public ReadOnly Property TagFormat(ByVal Tag As Tags) As ExifTagFormat
				Get
					...
					Select Case Tag
						...
						Case Tags.ExposureProgram : Return New ExifTagFormat(1, &h8822, "ExposureProgram", ExifIFDReader.DirectoryEntry.ExifDataTypes.URational)
						...
						Case Tags.GainControl : Return New ExifTagFormat(1, &hA407, "GainControl", ExifIFDReader.DirectoryEntry.ExifDataTypes.URational)
