...
#Region "Groups"
		...
		Partial Class GroupInfo
			...
			Public Shared ReadOnly Property ARM As GroupInfo
				Get
					Return New GroupInfo("ARM", "ARM", Groups.ARM, GetType(ARMGroup), "Old IPTC", "Abstract Relation Method", false, false, GetTag(RecordNumbers.Envelope, EnvelopeTags.ARMIdentifier), GetTag(RecordNumbers.Envelope, EnvelopeTags.ARMVersion))
				End Get
			End Property
			''' <summary>Country/geographical location referenced by the content of the object</summary>
			...
			Public Shared ReadOnly Property Reference As GroupInfo
				Get
					Return New GroupInfo("Reference", "Reference", Groups.Reference, GetType(ReferenceGroup), "Old IPTC", "Identifies a prior envelope to which the current object refers.", false, true, GetTag(RecordNumbers.Application, ApplicationTags.ReferenceService), GetTag(RecordNumbers.Application, ApplicationTags.ReferenceDate), GetTag(RecordNumbers.Application, ApplicationTags.ReferenceNumber))
				End Get
			End Property
			''' <summary>Creator of the object data</summary>
			...
			Public Shared ReadOnly Property ByLineInfo As GroupInfo
				Get
					Return New GroupInfo("ByLineInfo", "ByLineInfo", Groups.ByLineInfo, GetType(ByLineInfoGroup), "Author", "Creator of the object data", false, true, GetTag(RecordNumbers.Application, ApplicationTags.ByLine), GetTag(RecordNumbers.Application, ApplicationTags.ByLineTitle))
				End Get
			End Property
			''' <summary>Preview of embeded object</summary>
