...
#End Region
    ...
    <AttributeUsage(AuthorAndVersionAttributesUsage, AllowMultiple:=False, Inherited:=False)> _
    <Author("Ðonny", "dzony.dz@gmail.com"), Version(1, 0, GetType(DoNotApplyAuthorAndVersionAttributesAttribute), LastChange:="12/20/2006")> _
    ...
    <Author("Ðonny", "dzony.dz@gmail.com"), Version(1, 0, GetType(AttributesSpecificDeclarations), LastChange:="12/20/2006")> _
