...
#If Config <= RC Then 'Stage:RC
    ...
    <Version(1, 0, GetType(IIndexable(Of Byte, Byte)), LastChange:="4/23/2007")> _
    ...
    ''' <typeparam name="TItem">Datatype of items</typeparam>
    <Author("Ðonny", "dzonny@dzonny.cz", "http://dzonny.cz")> _
    <Version(1, 0, GetType(IReadOnlyIndexable(Of Byte, Byte)), LastChange:="4/23/2007")> _
    ...
    <Author("Ðonny", "dzonny@dzonny.cz", "http://dzonny.cz")> _
    <Version(1, 0, GetType(IIndexable(Of Byte)), LastChange:="4/23/2007")> _
    ...
    ''' <typeparam name="TItem">Data type of items</typeparam>
    <Author("Ðonny", "dzonny@dzonny.cz", "http://dzonny.cz")> _
    <Version(1, 0, GetType(IReadOnlyIndexable(Of Byte)), LastChange:="4/23/2007")> _
