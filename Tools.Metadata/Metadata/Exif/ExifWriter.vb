...
#Region "CTors"
        ...
        Public Sub New(ByVal Stream As IO.Stream, ByVal Map As ReaderItemKinds())
            ...
            If Map(0) <> ReaderItemKinds.Bom OrElse Map(1) <> ReaderItemKinds.Bom OrElse Map(2) <> ReaderItemKinds.BomTest OrElse Map(3) <> ReaderItemKinds.BomTest OrElse Map(4) <> ReaderItemKinds.Ifd0Offset OrElse Map(5) <> ReaderItemKinds.Ifd0Offset OrElse Map(6) <> ReaderItemKinds.NextSubIfdOffset OrElse Map(7) <> ReaderItemKinds.Ifd0Offset Then _
...
#Region "Write"
        ...
        Public Sub EndWriting()
            ...
            _Writer.BaseStream.SetLength(LastPosition)
...
#Region "Helpers"
        ...
        ''' <returns>When <see cref="WriterState"/> is <see cref="WriterStates.Records"/> gets numbe of records (of total <see cref="RecordsToWrite"/>) that was already written to current IFD; otherwise is meaningless.</returns>
