...
namespace Tools{namespace TotalCommanderT{
    ...
    public:
        ...
        /// <remarks>Those flags are pased to Total Commander by <see2 cref2="M:Tools.TotalCommanderT.ContentPluginBase.GetSupportedFieldFlags(System:Int32)"/>, which by default utilizes this property and can be overriden.</remarks>
