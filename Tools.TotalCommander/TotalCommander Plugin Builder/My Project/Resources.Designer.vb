...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  Looks up a localized string similar to Cannot expand {0}: {1}.
        '''</summary>
        Friend ReadOnly Property e_CannotExpand() As String
            Get
                Return ResourceManager.GetString("e_CannotExpand", resourceCulture)
            End Get
        End Property
        ...
        '''<summary>
        '''  Looks up a localized string similar to Error while extracting icon using {0}: {1}: {2}.
        '''</summary>
        Friend ReadOnly Property e_ExtractingIcon() As String
            Get
                Return ResourceManager.GetString("e_ExtractingIcon", resourceCulture)
            End Get
        End Property
        ...
        '''<summary>
        '''  Looks up a localized string similar to Clean copy directory {0}.
        '''</summary>
        Friend ReadOnly Property i_CleanCopyDirectory() As String
            Get
                Return ResourceManager.GetString("i_CleanCopyDirectory", resourceCulture)
            End Get
        End Property
        
        '''<summary>
        '''  Looks up a localized string similar to Copying app.config file from {0} to {1}.
        '''</summary>
        Friend ReadOnly Property i_CopyAppConfig() As String
            Get
                Return ResourceManager.GetString("i_CopyAppConfig", resourceCulture)
            End Get
        End Property
        ...
        '''<summary>
        '''  Looks up a localized string similar to Copy output to {0}.
        '''</summary>
        Friend ReadOnly Property i_CopyOutputTo() As String
            Get
                Return ResourceManager.GetString("i_CopyOutputTo", resourceCulture)
            End Get
        End Property
        ...
        '''</summary>
        Friend ReadOnly Property i_ExtractingIcon() As String
            Get
                Return ResourceManager.GetString("i_ExtractingIcon", resourceCulture)
            End Get
        End Property
        ...
        '''</summary>
        Friend ReadOnly Property i_ProjectFinished() As String
            Get
                Return ResourceManager.GetString("i_ProjectFinished", resourceCulture)
            End Get
        End Property
        ...
        '''</summary>
        Friend ReadOnly Property i_ProjectStarted() As String
            Get
                Return ResourceManager.GetString("i_ProjectStarted", resourceCulture)
            End Get
        End Property
        ...
        '''<summary>
        '''  Looks up a localized string similar to Target Started: .
        '''</summary>
        Friend ReadOnly Property i_TargetStarted() As String
            Get
                Return ResourceManager.GetString("i_TargetStarted", resourceCulture)
            End Get
        End Property
