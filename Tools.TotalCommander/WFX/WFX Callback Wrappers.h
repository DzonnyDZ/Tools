...
/// Function wrapper class stores internally one of the callbacks
/// and exposes externally call operators for all there signatures
/// and internally converts calls, parameters and return values for the only function stored internally.
...
namespace Tools {
    namespace TotalCommanderT {
        ...
        ref class FileSystemPlugin; //Forward reference
        ...
        public:
            ...
            /// <exception cref="ArgumentNullException"><paramref name="sender"/> is null</exception>
            /// <remarks>
            /// This method is not CLS-compliant. CLS-compliant alternative is <see cref="Invoke"/>.
            /// <para>When <paramref name="MsgType"> is <see cref2="F:Tools.TotalCommader.LogKind.Connect"/> the string must have special format. See <see cref="FileSystemPlugin::LogProc"/> for details.</para>
            /// </remarks>
            [CLSCompliant(false)]
