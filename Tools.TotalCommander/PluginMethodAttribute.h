...
namespace Tools {
    namespace TotalCommanderT {
        ...
        private:
            ...
            /// <summary>A regular expression to detect if macro name is OK</summary>
        ...
        public:
            ...
            /// <param name="ImplementedBy">Name of corresponding derived-class implemented method, to check for <see cref="MethodNotSupportedAttribute"/> to identify if this method should be included in plugin. See <see cref="ImplementedBy"/> for details.</param>
            /// <exception cref="ArgumentNullException"><paramref name="DefinedBy"/> is null</exception>
            ...
            /// <summary>Gets name of corresponding derived-class implemented method, to check for <see cref="MethodNotSupportedAttribute"/> to identify if this method should be included in plugin (by definition macro which name is defined by <see cref="DefinedBy"/>.</summary>
            ...
            /// <returns>Name to export function under. This name is written by Total Commander Plugin Generator to the *.def file. If null actual name of function is used.</returns>
            /// <value>Name of function to write to the *.def file. This property must be set directly, it cannot be set via CTor. Default value is null</value>
            /// <remarks>If function name starts with "<c>*</c>", * is replaced with plugin name prefix according to actual plugin type being generated:
            ...
            /// <summary>Gets or sets additional condition that must be fulfilled the function to be exported</summary>
            /// <returns>The condition as <c>constant-expression</c>; null when condition is always true</returns>
