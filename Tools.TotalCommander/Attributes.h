...
namespace Tools {
    namespace TotalCommanderT {
        ...
        public:
            ...
            /// <exception cref="ArgumentNullException"><paramref name="method"/> is null</exception>
            /// <remarks>You should specify target type using various properties of this class. If no target type is not specified actual type method this attribute is applied on is member of will be used.</remarks>
            ...
            /// <remarks>If multiple methods of this name are defined on target type specify method signature using <see cref="MethodParameters"/> otherwise <see cref="System::Reflection::AmbiguousMatchException"/> will be thrown.</remarks>
            ...
            /// <remarks>If <see cref="Hint"/> is not null method to provide attributes is first sought at this type and then method which overrides/implements this method is located on target type.</remarks>
            ...
            /// </exception>
            /// <exception cref="MissingMethodException">Method not found on target type or <see cref="Hint"/> -or- Method was found on <see cref="Hint"/> but method which overrides or implements in was not found on target type (it might be found of one of target type's base types, but such methods are excluded from lookup).</exception>
        ...
        /// <remarks>This attribute may be useful when you have non-abstract base class that you don't want plugin to be generated for</remarks>
        /// <version version="1.5.4">The class is now <see langword="selaed"/></version>
        ...
        public:
            /// <summary>When overridden in derived class gets the icon</summary>
        ...
        public:
            /// <summary>CTor</summary>
            /// <param name="IconPath">Path of ICO file that contains icon of plugin. Absolute or relative to assembly where type attribute is applied onto is declared.</param>
            ...
            /// <returns>Path of ICO file that contains icon of plugin. Absolute or relative to assembly where type attribute is applied onto is declared.</returns>
        ...
        public:
            /// <summary>CTor for embedded ICO resource</summary>
            /// <param name="TypeInAssembly">Any type in assembly resource is defined in</param>
            /// <param name="ResourceName">Name of embedded resource of type icon</param>
            ...
            /// <summary>CTor for embedded RESX resource</summary>
            /// <param name="TypeInAssembly">Any type in assembly resource is defined in</param>
            ...
            /// <summary>Get name of embedded resource that contains the icon</summary>
