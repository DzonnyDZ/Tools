...
#define TC_FS_MKDIR
#define TC_FS_EXECUTEFILE
#define TC_FS_RENMOVFILE
#define TC_FS_GETFILE
#define TC_FS_PUTFILE
#define TC_FS_DELETEFILE
#define TC_FS_REMOVEDIR
#define TC_FS_DISCONNECT
#define TC_FS_SETATTR 
#define TC_FS_SETTIME
#define TC_FS_STATUSINFO
#define TC_FS_GETDEFROOTNAME
#define TC_FS_EXTRACTCUSTOMICON
