...
//    /// <summary>This class contains methods fro resolving assembly references used by plugin</summary>
//    private ref class AssemblyResolver{
//    private:    
//        /// <summary>Resolver reference to assembly. Handles the <see cref="AppDomain::AssemblyResolve"/> event.</summary>
//        /// <param name="sender">The source of the event</param>
//        /// <param name="args">Event arguments</param>
//        /// <returns>Assembly resolved</returns>
