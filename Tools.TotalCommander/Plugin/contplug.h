...
TCPLUGF void __stdcall ContentPluginUnloading(void);
TCPLUGF void __stdcall ContentStopGetValue(char* FileName);
TCPLUGF int __stdcall ContentGetDefaultSortOrder(int FieldIndex);
TCPLUGF int __stdcall ContentGetSupportedFieldFlags(int FieldIndex);
TCPLUGF int __stdcall ContentSetValue(char* FileName,int FieldIndex,int UnitIndex,int FieldType,void* FieldValue,int flags);
