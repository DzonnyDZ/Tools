...
#pragma region Load
        ...
        protected:
            ...
            /// <summary>When overridden in derived class called when user opens lister.</summary>
...
#pragma region LoadNext
        public:
            ...
            /// <summary>When overridden in derived class called when user switches to the next or previous file in lister using 'n' or 'p' keys, or goes to the next/previous file in the Quick View Panel, and when the definition string either doesn't exist, or its evaluation returns true.</summary>
...
#pragma region GetDetectString
        ...
        public:
            /// <summary>When overridden in derived class gets a parse function which allows Lister to find out whether your plugin can probably handle the file or not.</summary>
            /// <returns>
...
#pragma region SearchText
        public:
            ...
            /// <summary>When overridden in derived class called when the user tries to find text in the plugin.</summary>
...
#pragma region SendCommand
        public:
            ...
            /// <summary>When overridden in derived class called when the user changes some options in Lister's menu.</summary>
            /// <param name="listerUI">An instance of lister plugin UI. Null in rare cases whan Total Commander calls <see cref="ListSearchText"/> with handle unknown to managed plugin framework</param>
            /// <param name="listerUIHandle">Handle of <paramref name="listerUI"/></param>
            /// <param name="command">One of <see cref="ListerCommand"> commands</param>
            /// <param name="parameter">Used when <paramref name="command"/> is <see cref="ListerCommand::NewParams"/>. Combination of <see cref="ListerShowFlags"/>.</param>
...
#pragma region Print
            ...
            /// <summary>When overridden in derived class called when the user chooses the print function.</summary>
            /// <param name="listerUI">An instance of lister plugin UI. Null in rare cases whan Total Commander calls <see cref="ListSearchText"/> with handle unknown to managed plugin framework</param>
            /// <param name="listerUIHandle">Handle of <paramref name="listerUI"/></param>
...
#pragma region NotificationReceived
        public:
            ...
            /// <summary>When overridden in derived class called when the parent window receives a notification message from the child window.</summary>
            /// <param name="listerUI">An instance of lister plugin UI. Null in rare cases whan Total Commander calls <see cref="ListSearchText"/> with handle unknown to managed plugin framework</param>
            /// <param name="listerUIHandle">Handle of <paramref name="listerUI"/></param>
...
#pragma region GetPreviewBitmap
            ...
            /// <summary>When overridden in derived class called to retrieve a bitmap for the thumbnails view.</summary>
            /// <param name="fileToLoad">The name of the file for which to load the preview bitmap.</param>
            /// <param name="width">Requested maximum width of the bitmap.</param>
            /// <param name="height">Requested maximum height of the bitmap</param>
...
#pragma region SearchDialog
            ...
            /// <remarks>Primary way of handling this event is to override <see cref="ShowSearchDialog"/>. This event is raised only if that function is overridden.
        ...
        protected:
            ...
            /// <remarks>Only purpose of this method is to raise the <see cref="SearchDialogShowing"/>. Primary way of handlig this event is to override <see cref="ShowSearchDialog"/>. This method is called only if <paramref name="ShowSearchDialog"/> is overridden.
            /// <note type="inheritinfo">Do not throw anny exceptions form overridden method. Such exception would be passed to Total Commander which cannot handle it.</note></para>
