...
Namespace TextT.UnicodeT
    ...
    Public Class CodePointInfoCollection
        ...
        ''' The number of elements in the source <see cref="CodePointInfoCollection" /> is greater than the available space from  <paramref name="arrayIndex" /> to the end of the destination <paramref name="array" />. -or-
        ''' Type  <see cref="UnicodeCodePoint" /> cannot be cast automatically to the type of the destination <paramref name="array" />.
        ''' </exception>
