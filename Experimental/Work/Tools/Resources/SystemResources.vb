'http://www.codeplex.com/DTools/SourceControl/FileView.aspx?itemId=305946&changeSetId=34746
Imports System.Reflection, System.ComponentModel
Namespace Resources
    ...
    Public NotInheritable Class WinFormsSystemResources
        ...
        Private Shared ReadOnly Property SRType() As Type
            Get
                ...
                If t Is Nothing Then
                    Dim a As Assembly = GetType(System.Windows.Forms.Form).Assembly
                    t = a.GetType("System.Windows.Forms.SR", True)
                End If
                Return t
            End Get
        End Property
...
#End Region
    ...
    Public Class WinFormsSRDescriptionAttribute
        ...
        Public Sub New(ByVal ResourceKey As WinFormsSystemResources.KnownValues)
        ...
        Public Overrides ReadOnly Property Description() As String
            Get
                Return WinFormsSystemResources.Value(ResourceKey)
            End Get
        End Property
    ...
    Public Class WinFormsSRCategoryAttribute
        Inherits CategoryAttribute
        ''' <summary>CTor</summary>
        ''' <param name="ResourceKey">Known resource key to get value from</param>
        ''' <remarks>This CTor is only hint for intellisense. However it is fully functional you will propebly never use it.</remarks>
        Public Sub New(ByVal ResourceKey As WinFormsSystemResources.KnownValues)
            MyBase.New(WinFormsSystemResources.Value(ResourceKey))
        End Sub
        ''' <summary>CTor</summary>
        ''' <param name="ResourceKey">Resource key to get value from</param>
        Public Sub New(ByVal ResourceKey As String)
