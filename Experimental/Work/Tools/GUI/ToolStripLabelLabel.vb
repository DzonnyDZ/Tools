Imports Tools.CollectionsT.GenericT, Tools, System.ComponentModel, Tools.ComponentModelT
...
#Region "Overloads"
        ...
        <KnownCategory(KnownCategoryAttribute.KnownCategories.Appearance), DefaultValue(1), Tools.ResourcesT.SRDescription("LabelTextAlignDescr"), Localizable(True)> _
        ...
        '<DefaultValue(True)> _
        '<SRDescription("LabelAutoSizeDescr"), Category(CategoryAttributeValues.Layout)> _
...
#Region "Label"
        ...
        <AmbientValue(CStr(Nothing)), ResourcesT.SRCategory("CatAppearance"), ResourcesT.SRDescription("ControlCursorDescr")> _
        ...
        <ResourcesT.SRDescription("LabelAutoEllipsisDescr"), KnownCategory(KnownCategoryAttribute.KnownCategories.Behavior), DefaultValue(False)> _
        ...
        <ResourcesT.SRDescription("LabelBorderDescr"), DefaultValue(0), KnownCategory(KnownCategoryAttribute.KnownCategories.Appearance)> _
        ...
        <KnownCategory(KnownCategoryAttribute.KnownCategories.Appearance), DefaultValue(2), ResourcesT.SRDescription("ButtonFlatStyleDescr")> _
        ...
        <KnownCategory(KnownCategoryAttribute.KnownCategories.Appearance), ResourcesT.SRDescription("ButtonImageDescr"), Localizable(True)> _
        ...
        ''' <exception cref="T:System.ComponentModel.InvalidEnumArgumentException">The value assigned is not one of the <see cref="T:System.Drawing.ContentAlignment"></see> values. </exception>
        <Localizable(True), ResourcesT.SRDescription("ButtonImageAlignDescr"), KnownCategory(KnownCategoryAttribute.KnownCategories.Appearance), DefaultValue(&H20)> _
        ...
        <ResourcesT.SRDescription("ButtonImageIndexDescr"), Editor("System.Windows.Forms.Design.ImageIndexEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", GetType(UITypeEditor)), DefaultValue(-1), KnownCategory(KnownCategoryAttribute.KnownCategories.Appearance), RefreshProperties(RefreshProperties.Repaint), Localizable(True), TypeConverter(GetType(ImageIndexConverter))> _
        ...
        <DefaultValue(True), ResourcesT.SRDescription("LabelUseMnemonicDescr"), KnownCategory(KnownCategoryAttribute.KnownCategories.Appearance)> _
