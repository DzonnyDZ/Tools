'http://www.codeplex.com/DTools/SourceControl/FileView.aspx?itemId=472055&changeSetId=40884
...
Namespace GUI
    ...
    Public Class ProgressMonitor
        ...
        Public Sub New()
            Me.new(GetBgw)
        End Sub
        Private Shared Function GetBgw() As BackgroundWorker
        ...
        Public Property BackgroundWorker() As BackgroundWorker
            ...
            Private Set(ByVal value As BackgroundWorker)
                ...
                If value IsNot bgw Then
                    ...
                    If bgw.WorkerReportsProgress Then _
                        pgbProgress.Style = ProgressBarStyle.Blocks _
                    Else pgbProgress.Style = ProgressBarStyle.Marquee
                End If
            End Set
        End Property
        ...
        Protected Overridable Sub OnProgressChanged(ByVal sender As Object, ByVal e As System.ComponentModel.ProgressChangedEventArgs) Handles bgw.ProgressChanged
        ...
        Protected Overridable Sub OnRunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles bgw.RunWorkerCompleted
        ...
        Protected Overridable Sub OnCancel(ByVal sender As Object, ByVal e As EventArgs) Handles cmdCancel.Click
        ...
        Private Sub ProgressMonitor_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
            If BackgroundWorker.IsBusy Then e.Cancel = True
        End Sub

        ''' <summary>Disposes of the resources (other than memory) used by the <see cref="System.Windows.Forms.Form"/>.</summary>
