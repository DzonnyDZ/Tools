        ...
        Private Sub ProcessMessageForTitleButton(ByRef m As Message)
            If Me.FormBorderStyle <> Windows.Forms.FormBorderStyle.None AndAlso Me.HelpButton AndAlso Me.ControlBox AndAlso ((Me.FormBorderStyle = Windows.Forms.FormBorderStyle.FixedToolWindow OrElse Me.FormBorderStyle = Windows.Forms.FormBorderStyle.SizableToolWindow) OrElse
                ...
                If CustomHelpButton Is Nothing Then
                    ...
                    CustomHelpButton.ButtonMenuText = "Nápovìda"
                End If
...
#End Region
#Region "System menu"
        ''' <summary>Skladuje položky pøidané do systémového menu</summary>
        Private AddedMenuItems As New Dictionary(Of Integer, MenuItem)
        ''' <summary>Pøidá položku do systémového menu</summary>
        ''' <param name="Index">Index položky</param>
        ''' <param name="Item">Položka</param>
        ''' <exception cref="API.Win32APIException">Chyba pøi pøidávání</exception>
