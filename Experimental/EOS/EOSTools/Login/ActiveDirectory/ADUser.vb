...
#End Region
        ...
        Private Sub New(Optional ByVal AllowInteractive As Boolean = True, Optional ByVal AppDisplayName As String = "")
            ...
            Else
                ...
                Catch ex As UserNotFoundException
                    ...
                    If MsgBox("Nepodaøilo se vás ovìøit vùèi ActiveDirectory. Chcete se pøihlásit ruènì?", MsgBoxStyle.Exclamation Or MsgBoxStyle.YesNo, "Login @ " & My.Application.Info.Title) = MsgBoxResult.Yes Then
                        LoginInteractive()
                    Else
        ...
        '        ''' <summary>Ovìøí uživatele z ActiveDirectory proti MySQL (Login, LoginUser)</summary>
        ...
        '                        End Select
        '                    Else
        '                        Throw New UserNotFoundException("Uživatel nebyl nalezen v databázi Login.")
        '                    End If
        '                Else
        '                    Id = DBUsers(0).ID
        '                End If
        ...
        '        End Sub
        '''' <summary>Vytvoøení nového úètu Login a navázání na úèet ActiveDirectory</summary>
        ...
        '''' <summary>Asociování existujícího úètu Login s úètem ActiveDirectory</summary>
        ...
        '    Dim OldUser As User = L.InvokeMember("Login", Reflection.BindingFlags.Static Or Reflection.BindingFlags.Public Or Reflection.BindingFlags.InvokeMethod, Nothing, Nothing, New Object() {Nothing, True, "Login - Pøihlášení ke starému úètu"})
        '    '= Login.Login.Login(, True, "Login - Pøihlášení ke starému úètu")
...
#End Region
        ...
        '    TrayIcon.ShowBalloonTip(2000, "Login - Active Directory", String.Format("Pøihlášen jako {0} {1}", Jmeno, Prijmeni, vbCrLf, PrincipalName), ToolTipIcon.Info) '({3}){2}Pro pøihlášení s jinými údaji ukonèete aplikaci a pø pøíštím pøístupu do zaheslované zóny mìjte zaplý Caps Lock a držte Shift.
        'End Sub
    End Class
End Namespace
