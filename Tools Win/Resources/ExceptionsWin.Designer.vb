...
Namespace ResourcesT
    ...
    Public Class ExceptionsWin
        ...
        '''</summary>
        Public Shared ReadOnly Property InstanceAPIMethodsAreNotAllowed() As String
            Get
                Return ResourceManager.GetString("InstanceAPIMethodsAreNotAllowed", _resourceCulture)
            End Get
        End Property
        ...
        Public Shared Function InstanceAPIMethodsAreNotAllowedFormat() As String
            Return InstanceAPIMethodsAreNotAllowed
        End Function
