...
Namespace API
    Friend Module Hooks
        ...
        Public Delegate Function LowLevelKeyboardProc(ByVal nCode%, ByVal wParam As IntPtr, ByVal lParam As IntPtr) As IntPtr
        ...
        Public Declare Auto Function SetWindowsHookEx Lib "user32.dll" (ByVal idHook As WindowsHook, ByVal lpfn As LowLevelKeyboardProc, ByVal hMod As IntPtr, ByVal dwThreadId As UInteger) As IntPtr
