...
namespace Tools.GeneratorsT {
    ...
    public class TransformCodeGenerator:CustomToolBase {
        ...
        public override string DoGenerateCode(string inputFileName, string inputFileContent) {
            ...
            string transformerFileName = Tools.ResourcesT.Resources.NOTFOUND;
            ...
            try {
                ...
                outputWriter.WriteLine("\t" + Tools.ResourcesT.Resources.ERRORUnableToGenerateOutputForTemplate);
                outputWriter.WriteLine("\t'{0}'", inputFileName);
                outputWriter.WriteLine("\t" + Tools.ResourcesT.Resources.UsingTransformer);
