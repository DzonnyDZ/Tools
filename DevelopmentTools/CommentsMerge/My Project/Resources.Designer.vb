...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''</summary>
        Friend ReadOnly Property CommentsMergeMergesXMLCommentFiles() As String
            Get
                Return ResourceManager.GetString("CommentsMergeMergesXMLCommentFiles", resourceCulture)
            End Get
        End Property
        
        '''<summary>
        '''  Looks up a localized string similar to Files should be namespace-less or have http://dzonny.cz/xml/schemas/intellisense namespace.
        '''</summary>
        Friend ReadOnly Property FilesShouldBeNamespaceLessOrHaveHttpDzonnyCzXmlSchemasIntellisenseNamespace() As String
            Get
                Return ResourceManager.GetString("FilesShouldBeNamespaceLessOrHaveHttpDzonnyCzXmlSchemasIntellisenseNamespace", resourceCulture)
            End Get
        End Property
        ...
        '''<summary>
        '''  Looks up a localized string similar to Usage: CommenstMerge PrimaryFile SecondaryFile OutputFile.
        '''</summary>
        Friend ReadOnly Property UsageCommenstMergePrimaryFileSecondaryFileOutputFile() As String
            Get
                Return ResourceManager.GetString("UsageCommenstMergePrimaryFileSecondaryFileOutputFile", resourceCulture)
            End Get
        End Property
    End Module
End Namespace
