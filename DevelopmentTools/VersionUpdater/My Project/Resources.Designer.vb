...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  Looks up a localized string similar to mode = Timestamp | Increment|Svn:dirpath.
        '''</summary>
        ...
        '''<summary>
        '''  Looks up a localized string similar to dirpath - path to a SVN-controled directory to get revision number of (it&apos;s read from .svn\entries).
        '''</summary>
