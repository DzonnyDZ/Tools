...
#End Region
        ...
        Public Sub ToString_CustomSimple()
            ...
            Assert.AreEqual("60", a1.ToString("-d", culture))
            Assert.AreEqual("-60", a2.ToString("-d", culture))
            Assert.AreEqual("+60", a1.ToString("+d", culture))
            Assert.AreEqual("-60", a2.ToString("+d", culture))
            Assert.AreEqual("60.5", a1.ToString("%D1", culture))
            Assert.AreEqual("61", a1.ToString("%D0", culture))
            ...
            Assert.AreEqual((a1.ToRadians / Math.PI).ToString("n", culture), a1.ToString("%p", culture))
            Assert.AreEqual((a1.ToRadians / Math.PI).ToString("n", culture), a1.ToString("%π", culture))
            Assert.AreEqual((a2.ToRadians / Math.PI).ToString("n", culture), a2.ToString("-π", culture))
            Assert.AreEqual((a2.ToRadians / Math.PI).ToString("n", culture), a2.ToString("-p", culture))
            Assert.AreEqual(a1.ToRadians.ToString("n", culture), a1.ToString("%R", culture))
            Assert.AreEqual(a2.ToRadians.ToString("n", culture), a2.ToString("-R", culture))
            ...
            Assert.AreEqual(a1.ToGradians.ToString("n", culture), a1.ToString("%Z", culture))
            Assert.AreEqual(a2.ToGradians.ToString("n", culture), a2.ToString("-Z", culture))
            ...
            Assert.AreEqual("315-100", a3.ToString("d-L", culture))
            Assert.AreEqual("100-315", a3.ToString("L-d", culture))
            Assert.AreEqual("315-100", a3.ToString("d+L", culture))
            Assert.AreEqual("100-315", a3.ToString("L+d", culture))

            Assert.AreEqual("315-100", a3.ToString("d|-L", culture))
            Assert.AreEqual("315100", a3.ToString("d-|L", culture))
            Assert.AreEqual("100-315", a3.ToString("L-|d", culture))
            Assert.AreEqual("100315", a3.ToString("L|-d", culture))
            Assert.AreEqual("315+100", a3.ToString("d+|L", culture))
            Assert.AreEqual("315-100", a3.ToString("d|+L", culture))
            Assert.AreEqual("100-315", a3.ToString("L+|d", culture))
            Assert.AreEqual("100+315", a3.ToString("L|+d", culture))
        ...
        <TestMethod>
        Public Sub ToString_Complex()
            Dim c = InvariantCulture
            Dim a_0_0_0 = Angle.Zero
            Dim a_1_0_0 = New Angle(1)
            Dim a_0_1_0 = New Angle(0, 1, 0)
            Dim a_1_1_0 = New Angle(1, 1, 0)
            Dim a_0_0_1 = New Angle(0, 0, 1)
            Dim a_0_0_01 = New Angle(0, 0, 0.1@)
            Dim a_1_0_1 = New Angle(1, 0, 1)
            Dim a_1_0_01 = New Angle(1, 0, 0.1@)
            Dim a_1_1_1 = New Angle(1, 1, 1)

            For Each a In {a_0_0_0, a_1_0_0, a_0_1_0, a_1_1_0, a_0_0_1, a_0_0_01, a_1_0_1, a_1_0_01, a_1_1_1}
                Assert.AreEqual(String.Format(c, "{0}-{1}-{2}-{3}",
                                              If(a.Degrees > 0, a.Degrees.ToString(), ""),
                                              If(a.Minutes > 0, a.Minutes.ToString(), ""),
                                              If(a.Seconds >= 1, Math.Floor(a.Seconds).ToString(), ""),
                                              If(a.Seconds Mod 1 <> 0, Math.Floor((a.Seconds Mod 1) * 10).ToString, "")),
                                a.ToString("[d]\-[m]\-[s]\-[f]", c), a.ToString()
                               )
            Next

            Assert.AreEqual("", a_0_0_0.ToString("c[d°][m'][s[.fff]""]", c))
            Assert.AreEqual("1°", a_1_0_0.ToString("c[d°][m'][s[.fff]""]", c))
            Assert.AreEqual("1'", a_0_1_0.ToString("c[d°][m'][s[.fff]""]", c))
            Assert.AreEqual("1""", a_0_0_1.ToString("c[d°][m'][s[.fff]""]", c))
            Assert.AreEqual("1°1'", a_1_1_0.ToString("c[d°][m'][s[.fff]""]", c))
            Assert.AreEqual("1°1""", a_1_0_1.ToString("c[d°][m'][s[.fff]""]", c))
            Assert.AreEqual("1°1'1""", a_1_1_1.ToString("c[d°][m'][s[.fff]""]", c))
            Assert.AreEqual("0.100""", a_0_0_01.ToString("c[d°][m'][s[.fff]""]", c))
        ...
        Public Sub ToString_CustomProperties()
            For Each culture In {InvariantCulture, CurrentCulture, GetCultureInfo("en-US"), GetCultureInfo("cs"), GetCultureInfo("ar"), Nothing}
                For Each a In {New Angle(60, 30, 50.5#), New Angle(-60, 30, 50.5#), New Angle(100), New Angle(2000), New Angle(0), New Angle(0, 0, 0.0001#)}
                    Assert.AreEqual(CInt(a.TotalDegrees \ 24).ToString("000", culture), a.ToString("(Days,000)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.Degrees.ToString("000", culture), a.ToString("(Degrees,000)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.ToGradians.ToString("000.###", culture), a.ToString("(Gradians,000.###)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual((a.Degrees - (a.Degrees \ 24) * 24).ToString("0", culture), a.ToString("(Hours,0)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.Minutes.ToString("", culture), a.ToString("(Minutes,)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual((a.ToRadians / Math.PI).ToString("###,###.0#", culture), a.ToString("(PiRadians,###,###.0#)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.ToRadians.ToString("###,###.0#", culture), a.ToString("(Radians,###\,###.0#)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual((Math.Abs(a.TotalDegrees) - (Math.Abs(a.TotalDegrees) \ 24) * 24).ToString("f2", culture), a.ToString("(RestHours,f2)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual((a.TotalMinutes - a.Degrees * 60.0#).ToString("e", culture), a.ToString("(RestMinutes,e)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.Seconds.ToString("N", culture), a.ToString("(RestSeconds,N)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.ToRotations.ToString("g2", culture), a.ToString("(Rotations,g2)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.Seconds.ToString(CStr(Nothing), culture), a.ToString("(Seconds)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.ToSlope.ToString(" 0\%", culture), a.ToString("(Slope, 0\\%)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.ToSlope.ToString(" 0\%", culture), a.ToString("(Slope100 , 0\\%)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual((a.ToSlope / 100.0#).ToString("p", culture), a.ToString("(Slope1,p)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual((a.ToSlope / 100.0#).ToString("0.00%", culture), a.ToString("(Slope1,0.00%)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual((a.ToSlope / 100.0#).ToString("0.0‰", culture), a.ToString("(Slope1,0.0‰)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual((a.ToSlope * 10.0#).ToString("0.0\" + If(culture, InvariantCulture).NumberFormat.PerMilleSymbol, culture), a.ToString("(Slope1000,0.0\\‰)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(CType(a, TimeSpan).ToString("", culture), a.ToString("(Time,)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(CType(a, TimeSpanFormattable).ToString("[d] h:mm:ss", culture), a.ToString("(TimeFormattable,[d] h:mm:ss)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual((a.TotalDegrees / 24.0#).ToString("g", culture), a.ToString("(TotalDays,g)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.TotalDegrees.ToString("0.00", culture), a.ToString("(TotalDegrees,0.00)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.TotalDegrees.ToString("0,00", culture), a.ToString("(TotalDegrees,0,00)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.TotalMinutes.ToString("0.00m", culture), a.ToString("(TotalMinutes,0.00m)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.TotalSeconds.ToString("0.00m", culture), a.ToString("(TotalSeconds,0.00m)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                    Assert.AreEqual(a.Degrees.ToString("x", culture), a.ToString("(Degrees,x)", culture), String.Format("culture={0}, a={1}", If(culture Is Nothing, "", culture.Name), a))
                Next
            Next
        End Sub
