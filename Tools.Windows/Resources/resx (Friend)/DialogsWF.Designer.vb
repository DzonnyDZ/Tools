...
Namespace WindowsT.FormsT
    ...
    Friend Class Dialogs
        ...
        '''</summary>
        Friend Shared ReadOnly Property InnerException() As String
            Get
                Return ResourceManager.GetString("InnerException", _resourceCulture)
            End Get
        End Property
        ...
        Friend Shared Function InnerExceptionFormat() As String
