...
Namespace WindowsT.FormsT
    ...
    <System.Drawing.ToolboxBitmap(GetType(DataBoundToolStripLabel), "DataBoundToolStripLabel.bmp")>
    <DefaultBindingProperty("Text")>
    <ComponentModelT.Prefix("dtl")>
    Public Class DataBoundToolStripLabel : Inherits ToolStripLabel
        ...
        <LDescription(GetType(WindowsT.FormsT.DerivedControls), "DataBindings_d")>
        ...
        ''' <param name="e">Event parameters</param>
        <KnownCategory(KnownCategoryAttribute.KnownCategories.Data)>
        <LDescription(GetType(WindowsT.FormsT.DerivedControls), "BindingContextChanged_d")>
