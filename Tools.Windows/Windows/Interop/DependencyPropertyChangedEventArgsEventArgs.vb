...
Namespace WindowsT.InteropT
    ''' <summary>Wraps <see cref="Windows.DependencyPropertyChangedEventArgs"/> as clas derived from <see cref="EventArgs"/></summary>
    ...
    Public Class DependencyPropertyChangedEventArgsEventArgs
        Inherits EventArgs
        Implements IEquatable(Of DependencyPropertyChangedEventArgsEventArgs), IEquatable(Of Windows.DependencyPropertyChangedEventArgs)
        ''' <summary>CTor</summary>
        ''' <param name="DependencyPropertyChangedEventArgs">Instance to be wraped</param>
        Public Sub New(ByVal DependencyPropertyChangedEventArgs As Windows.DependencyPropertyChangedEventArgs)
            Me.e = DependencyPropertyChangedEventArgs
        End Sub
        ''' <summary>Instance being wrapped</summary>
        Public ReadOnly e As Windows.DependencyPropertyChangedEventArgs
        ''' <summary>Converts <see cref="Windows.DependencyPropertyChangedEventArgs"/> to <see cref="DependencyPropertyChangedEventArgsEventArgs"/></summary>
        ''' <param name="a">A <see cref="Windows.DependencyPropertyChangedEventArgs"/></param> 
        ''' <returns>New instance of <see cref="DependencyPropertyChangedEventArgsEventArgs"/> wrapping <paramref name="a"/></returns>
        Public Shared Widening Operator CType(ByVal a As Windows.DependencyPropertyChangedEventArgs) As DependencyPropertyChangedEventArgsEventArgs
            Return New DependencyPropertyChangedEventArgsEventArgs(a)
        End Operator
        ''' <summary>Converts <see cref="DependencyPropertyChangedEventArgsEventArgs"/> to <see cref="Windows.DependencyPropertyChangedEventArgs"/></summary>
        ''' <param name="a">A <see cref="DependencyPropertyChangedEventArgsEventArgs"/></param>
        ''' <returns><see cref="Windows.DependencyPropertyChangedEventArgs"/> wraped by <paramref name="a"/></returns>
        ''' <exception cref="ArgumentNullException"><paramref name="a"/> is null</exception>
        Public Shared Widening Operator CType(ByVal a As DependencyPropertyChangedEventArgsEventArgs) As Windows.DependencyPropertyChangedEventArgs
...
#Region "Lifting"
        ...
        ''' <seelaso cref="Windows.DependencyPropertyChangedEventArgs.OldValue"/>
        ...
        ''' <summary>Gets the value of the property before the change.</summary>
        ''' <returns>The property value before the change.</returns>
        ''' <seelaso cref="Windows.DependencyPropertyChangedEventArgs.NewValue"/>
        ...
        ''' <seelaso cref="Windows.DependencyPropertyChangedEventArgs.[Property]"/>
        Public ReadOnly Property [Property]() As Windows.DependencyProperty
            Get
                Return e.Property
            End Get
        End Property
#End Region
        ...
        ''' <remarks><see cref="DependencyPropertyChangedEventArgsEventArgs"/> can be compared to <see cref="windows.DependencyPropertyChangedEventArgs"/> and to <see cref="DependencyPropertyChangedEventArgsEventArgs"/>. Comparison with other types returns false.</remarks>
        ''' <filterpriority>2</filterpriority>
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            If obj Is Nothing Then Return False
            If TypeOf obj Is Windows.DependencyPropertyChangedEventArgs Then Return Me.Equals(DirectCast(obj, Windows.DependencyPropertyChangedEventArgs))
        ...
        End Function
        ''' <summary>Indicates whether the current object is equal to another object of the type <see cref="Windows.DependencyPropertyChangedEventArgs"/>.</summary>
        ...
        Public Overloads Function Equals(ByVal other As DependencyPropertyChangedEventArgsEventArgs) As Boolean Implements System.IEquatable(Of DependencyPropertyChangedEventArgsEventArgs).Equals
            Return other.e = e
        End Function
        ''' <summary>Compares <see cref="Windows.DependencyPropertyChangedEventArgs"/> and <see cref="DependencyPropertyChangedEventArgsEventArgs"/> for equality</summary>
        ''' <returns>true when <paramref name="a"/> equals to <paramref name="b"/></returns>
        ''' <param name="a">A Windows.DependencyPropertyChangedEventArgs</param>
        ''' <param name="b">A DependencyPropertyChangedEventArgsEventArgs</param>
        ''' <seelaso cref="Equals"/>
        Public Shared Operator =(ByVal a As Windows.DependencyPropertyChangedEventArgs, ByVal b As DependencyPropertyChangedEventArgsEventArgs) As Boolean
            If b Is Nothing Then Return False
            Return b.Equals(a)
        End Operator
        ''' <summary>Compares <see cref="DependencyPropertyChangedEventArgsEventArgs"/> and <see cref="Windows.DependencyPropertyChangedEventArgs"/> for equality</summary>
        ...
        ''' <param name="b">A Windows.DependencyPropertyChangedEventArgs</param>
        ''' <seelaso cref="Equals"/>
        Public Shared Operator =(ByVal a As DependencyPropertyChangedEventArgsEventArgs, ByVal b As Windows.DependencyPropertyChangedEventArgs) As Boolean
        ...
        Public Shared Operator =(ByVal a As DependencyPropertyChangedEventArgsEventArgs, ByVal b As DependencyPropertyChangedEventArgsEventArgs) As Boolean
            ...
            Return a.Equals(b)
        End Operator
        ''' <summary>Compares <see cref="Windows.DependencyPropertyChangedEventArgs"/> and <see cref="DependencyPropertyChangedEventArgsEventArgs"/> for inequality</summary>
        ...
        Public Shared Operator <>(ByVal a As Windows.DependencyPropertyChangedEventArgs, ByVal b As DependencyPropertyChangedEventArgsEventArgs) As Boolean
            Return Not a = b
        End Operator
        ''' <summary>Compares <see cref="DependencyPropertyChangedEventArgsEventArgs"/> and <see cref="Windows.DependencyPropertyChangedEventArgs"/> for inequality</summary>
