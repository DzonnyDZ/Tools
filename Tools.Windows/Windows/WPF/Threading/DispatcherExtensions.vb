...
#Region "Functions"
        ...
        <Extension()> Public Function Invoke(Of TResult)(ByVal [object] As Dispatcher, ByVal [delegate] As Func(Of TResult)) As TResult
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Function Invoke(Of T, TResult)(ByVal [object] As Dispatcher, ByVal [delegate] As Func(Of T, TResult), ByVal param1 As T) As TResult
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Function Invoke(Of T1, T2, TResult)(ByVal [object] As Dispatcher, ByVal [delegate] As Func(Of T1, T2, TResult), ByVal param1 As T1, ByVal param2 As T2) As TResult
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Function Invoke(Of T1, T2, T3, TResult)(ByVal [object] As Dispatcher, ByVal [delegate] As Func(Of T1, T2, T3, TResult), ByVal param1 As T1, ByVal param2 As T2, ByVal param3 As T3) As TResult
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Function Invoke(Of T1, T2, T3, T4, TResult)(ByVal [object] As Dispatcher, ByVal [delegate] As Func(Of T1, T2, T3, T4, TResult), ByVal param1 As T1, ByVal param2 As T2, ByVal param3 As T3, ByVal param4 As T4) As TResult
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Function Invoke(Of T1, T2, T3, T4, T5, TResult)(ByVal [object] As Dispatcher, ByVal [delegate] As Func(Of T1, T2, T3, T4, T5, TResult), ByVal param1 As T1, ByVal param2 As T2, ByVal param3 As T3, ByVal param4 As T4, ByVal param5 As T5) As TResult
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Function Invoke(Of T1, T2, T3, T4, T5, T6, TResult)(ByVal [object] As Dispatcher, ByVal [delegate] As Func(Of T1, T2, T3, T4, T5, T6, TResult), ByVal param1 As T1, ByVal param2 As T2, ByVal param3 As T3, ByVal param4 As T4, ByVal param5 As T5, ByVal param6 As T6) As TResult
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Function Invoke(Of T1, T2, T3, T4, T5, T6, T7, TResult)(ByVal [object] As Dispatcher, ByVal [delegate] As Func(Of T1, T2, T3, T4, T5, T6, T7, TResult), ByVal param1 As T1, ByVal param2 As T2, ByVal param3 As T3, ByVal param4 As T4, ByVal param5 As T5, ByVal param6 As T6, ByVal param7 As T7) As TResult
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
...
#Region "Procedures"
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Sub Invoke(ByVal [object] As Dispatcher, ByVal [delegate] As Action)
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Sub Invoke(Of T)(ByVal [object] As Dispatcher, ByVal [delegate] As Action(Of T), ByVal param1 As T)
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Sub Invoke(Of T1, T2)(ByVal [object] As Dispatcher, ByVal [delegate] As Action(Of T1, T2), ByVal param1 As T1, ByVal param2 As T2)
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Sub Invoke(Of T1, T2, T3)(ByVal [object] As Dispatcher, ByVal [delegate] As Action(Of T1, T2, T3), ByVal param1 As T1, ByVal param2 As T2, ByVal param3 As T3)
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Sub Invoke(Of T1, T2, T3, T4)(ByVal [object] As Dispatcher, ByVal [delegate] As Action(Of T1, T2, T3, T4), ByVal param1 As T1, ByVal param2 As T2, ByVal param3 As T3, ByVal param4 As T4)
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Sub Invoke(Of T1, T2, T3, T4, T5)(ByVal [object] As Dispatcher, ByVal [delegate] As Action(Of T1, T2, T3, T4, T5), ByVal param1 As T1, ByVal param2 As T2, ByVal param3 As T3, ByVal param4 As T4, ByVal param5 As T5)
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Sub Invoke(Of T1, T2, T3, T4, T5, T6)(ByVal [object] As Dispatcher, ByVal [delegate] As Action(Of T1, T2, T3, T4, T5, T6), ByVal param1 As T1, ByVal param2 As T2, ByVal param3 As T3, ByVal param4 As T4, ByVal param5 As T5, ByVal param6 As T6)
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Sub Invoke(Of T1, T2, T3, T4, T5, T6, T7)(ByVal [object] As Dispatcher, ByVal [delegate] As Action(Of T1, T2, T3, T4, T5, T6, T7), ByVal param1 As T1, ByVal param2 As T2, ByVal param3 As T3, ByVal param4 As T4, ByVal param5 As T5, ByVal param6 As T6, ByVal param7 As T7)
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
        ...
        ''' <exception cref="ArgumentNullException"><paramref name="object"/> or <paramref name="delegate"/> is null</exception>
        ''' <exception cref="TargetInvocationException">Exception was thrown while invoking the <paramref name="delegate"/>. See <see cref="TargetInvocationException.InnerException"/> for details.</exception>
        <Extension()> Public Sub Invoke(Of T1, T2, T3, T4, T5, T6, T7, T8)(ByVal [object] As Dispatcher, ByVal [delegate] As Action(Of T1, T2, T3, T4, T5, T6, T7, T8), ByVal param1 As T1, ByVal param2 As T2, ByVal param3 As T3, ByVal param4 As T4, ByVal param5 As T5, ByVal param6 As T6, ByVal param7 As T7, ByVal param8 As T8)
            If [object] Is Nothing Then Throw New ArgumentNullException("object")
            If [delegate] Is Nothing Then Throw New ArgumentNullException("delegate")
