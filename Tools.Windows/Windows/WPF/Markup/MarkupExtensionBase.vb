...
Namespace WindowsT.WPF.MarkupT
    ''' <summary>Base class for implementations of <see cref="MarkupExtension"/> which mekes it easier to implement <see cref="MarkupExtension"/> by provideing easier access to some commonly required services.</summary>
