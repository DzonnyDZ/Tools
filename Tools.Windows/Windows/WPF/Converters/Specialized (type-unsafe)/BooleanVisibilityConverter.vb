    ...
    Public Class BooleanVisibilityConverter
        ...
        Public Function Convert(ByVal value As Object, ByVal targetType As System.Type, ByVal parameter As Object, ByVal culture As System.Globalization.CultureInfo) As Object Implements System.Windows.Data.IValueConverter.Convert
            If TypeOf value Is Boolean AndAlso targetType.IsAssignableFrom(GetType(Windows.Visibility)) Then
                ...
                End If
            End If
            Throw New NotSupportedException(ConverterResources.ex_ConverterCanConvertOnlyFromTo.f(Me.GetType.Name, GetType(Boolean).Name, GetType(Windows.Visibility).Name))
        End Function
        ...
        Public Function ConvertBack(ByVal value As Object, ByVal targetType As System.Type, ByVal parameter As Object, ByVal culture As System.Globalization.CultureInfo) As Object Implements System.Windows.Data.IValueConverter.ConvertBack
            ...
            If TypeOf value Is Windows.Visibility AndAlso targetType.IsAssignableFrom(GetType(Boolean)) Then
                Select Case DirectCast(value, Windows.Visibility)
                    ...
                    Case Else : Throw New ArgumentException(ConverterResources.ex_ConverterCannotConvertValueBack.f(Me.GetType, GetType(Windows.Visibility).Name, value))
                End Select
            Else
                Throw New NotSupportedException(ConverterResources.ex_ConverterCanConvertBackOnlyFromTo.f(Me.GetType.Name, GetType(Windows.Visibility).Name, GetType(Boolean).Name))
            End If
