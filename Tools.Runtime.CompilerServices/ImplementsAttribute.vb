...
Namespace RuntimeT.CompilerServicesT
    ...
    Public Class ImplementsAttribute
        ...
        ''' <summary>Creates a new instance of the <see cref="ImplementsAttribute"/> class without specifying implemented member name</summary>
        ''' <param name="base">
        ...
        ''' Every item in this array passes one generic argument to <see cref="Base"/>. Generic arguments are referenced by position.
        ''' In case <see cref="Base"/> is nested type parent type arguments are before nested type arguments.
